...
/* Command for C compiler:
   gcc -c  -w  -I/usr/lib/nimrod -o /home/andreysh/Projects/nimrod/stone_head/nimcache/parseutils.o /home/andreysh/Projects/nimrod/stone_head/nimcache/parseutils.c */
...
static N_INLINE(void, HEX2AHEX3D_94524)(NF* x_94530, NF y_94533);
...
N_NIMCALL(NI, rawparseint_94331)(NimStringDesc* s, NI64* b, NI start);
...
N_NIMCALL(NF, tentothepowerof_94513)(NI b_94515);
STRING_LITERAL(TMP325, "overflow", 8);
...
N_NIMCALL(NI, rawparseint_94331)(NimStringDesc* s, NI64* b, NI start) {
	...
	nimln(200, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(203, "parseutils.nim");
			nimln(203, "parseutils.nim");
			TMP320 = mulInt64((*b), 10);
			nimln(203, "parseutils.nim");
			nimln(203, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP321 = subInt(((NI) (((NU8)(s->data[i])))), 48);
			TMP322 = subInt64((NI64)(TMP320), ((NI64) ((NI64)(TMP321))));
			(*b) = (NI64)(TMP322);
		...
		nimln(206, "parseutils.nim");
		TMP323 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP323);
		nimln(207, "parseutils.nim");
		nimln(207, "parseutils.nim");
		TMP324 = subInt(i, start);
		result = (NI64)(TMP324);
	}
	LA10: ;
	popFrame();
...
N_NIMCALL(NI, npuParseBiggestInt)(NimStringDesc* s, NI64* number, NI start) {
	...
	result = rawparseint_94331(s, &res, start);
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	nimln(228, "parseutils.nim");
	{
		...
		e_94486 = (EOverflow*) newObj((&NTI18601), sizeof(EOverflow));
		(*e_94486).Sup.Sup.Sup.Sup.m_type = (&NTI2445);
		nimln(1993, "system.nim");
		LOC9 = 0;
		LOC9 = (*e_94486).Sup.Sup.Sup.message; (*e_94486).Sup.Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP325));
		if (LOC9) nimGCunrefNoCycle(LOC9);
		nimln(230, "parseutils.nim");
		raiseException((E_Base*)e_94486, "EOverflow");
	}
	goto LA1;
	LA7: ;
	{
...
N_NIMCALL(NI, npuParseBiggestFloat)(NimStringDesc* s, NF* number, NI start) {
	...
	nimln(261, "parseutils.nim");
	{
		...
		nimln(262, "parseutils.nim");
		{
			...
			nimln(262, "parseutils.nim");
			TMP327 = addInt(i, 1);
			if ((NU)((NI64)(TMP327)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC16 = ((NU8)(s->data[(NI64)(TMP327)]) == (NU8)(65));
			if (LOC16) goto LA17;
			nimln(262, "parseutils.nim");
			nimln(262, "parseutils.nim");
			TMP328 = addInt(i, 1);
			if ((NU)((NI64)(TMP328)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC16 = ((NU8)(s->data[(NI64)(TMP328)]) == (NU8)(97));
			LA17: ;
			if (!LOC16) goto LA18;
			nimln(263, "parseutils.nim");
			{
				...
				nimln(263, "parseutils.nim");
				TMP329 = addInt(i, 2);
				if ((NU)((NI64)(TMP329)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC22 = ((NU8)(s->data[(NI64)(TMP329)]) == (NU8)(78));
				if (LOC22) goto LA23;
				nimln(263, "parseutils.nim");
				nimln(263, "parseutils.nim");
				TMP330 = addInt(i, 2);
				if ((NU)((NI64)(TMP330)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC22 = ((NU8)(s->data[(NI64)(TMP330)]) == (NU8)(110));
				LA23: ;
				if (!LOC22) goto LA24;
				nimln(264, "parseutils.nim");
				{
					...
					nimln(264, "parseutils.nim");
					TMP331 = addInt(i, 3);
					if ((NU)((NI64)(TMP331)) > (NU)(s->Sup.len)) raiseIndexError();
					if (!!((((NU8)(s->data[(NI64)(TMP331)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI64)(TMP331)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI64)(TMP331)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI64)(TMP331)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI64)(TMP331)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI64)(TMP331)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI64)(TMP331)])) == ((NU8)(95))))) goto LA28;
					...
					nimln(266, "parseutils.nim");
					TMP332 = addInt(i, 3);
					TMP333 = subInt((NI64)(TMP332), start);
					result = (NI64)(TMP333);
					goto BeforeRet;
				}
				LA28: ;
	...
	nimln(268, "parseutils.nim");
	{
		...
		nimln(269, "parseutils.nim");
		{
			...
			nimln(269, "parseutils.nim");
			TMP334 = addInt(i, 1);
			if ((NU)((NI64)(TMP334)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC38 = ((NU8)(s->data[(NI64)(TMP334)]) == (NU8)(78));
			if (LOC38) goto LA39;
			nimln(269, "parseutils.nim");
			nimln(269, "parseutils.nim");
			TMP335 = addInt(i, 1);
			if ((NU)((NI64)(TMP335)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC38 = ((NU8)(s->data[(NI64)(TMP335)]) == (NU8)(110));
			LA39: ;
			if (!LOC38) goto LA40;
			nimln(270, "parseutils.nim");
			{
				...
				nimln(270, "parseutils.nim");
				TMP336 = addInt(i, 2);
				if ((NU)((NI64)(TMP336)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC44 = ((NU8)(s->data[(NI64)(TMP336)]) == (NU8)(70));
				if (LOC44) goto LA45;
				nimln(270, "parseutils.nim");
				nimln(270, "parseutils.nim");
				TMP337 = addInt(i, 2);
				if ((NU)((NI64)(TMP337)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC44 = ((NU8)(s->data[(NI64)(TMP337)]) == (NU8)(102));
				LA45: ;
				if (!LOC44) goto LA46;
				nimln(271, "parseutils.nim");
				{
					...
					nimln(271, "parseutils.nim");
					TMP338 = addInt(i, 3);
					if ((NU)((NI64)(TMP338)) > (NU)(s->Sup.len)) raiseIndexError();
					if (!!((((NU8)(s->data[(NI64)(TMP338)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI64)(TMP338)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI64)(TMP338)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI64)(TMP338)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI64)(TMP338)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI64)(TMP338)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI64)(TMP338)])) == ((NU8)(95))))) goto LA50;
					...
					nimln(273, "parseutils.nim");
					TMP339 = addInt(i, 3);
					TMP340 = subInt((NI64)(TMP339), start);
					result = (NI64)(TMP340);
					goto BeforeRet;
				}
				LA50: ;
	...
	while (1) {
		...
		nimln(278, "parseutils.nim");
		if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
		TMP341 = subInt(((NI) (((NU8)(s->data[i])))), 48);
		(*number) = ((NF)(((NF)((*number)) * (NF)(1.0000000000000000e+01))) + (NF)(((double) (((NI) ((NI64)(TMP341)))))));
	...
	nimln(282, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(288, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP342 = subInt(((NI) (((NU8)(s->data[i])))), 48);
			(*number) = ((NF)(((NF)((*number)) * (NF)(1.0000000000000000e+01))) + (NF)(((double) (((NI) ((NI64)(TMP342)))))));
	...
	nimln(296, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(306, "parseutils.nim");
			nimln(306, "parseutils.nim");
			TMP343 = mulInt(exponent, 10);
			nimln(306, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP344 = addInt((NI64)(TMP343), ((NI) (((NU8)(s->data[i])))));
			TMP345 = subInt((NI64)(TMP344), 48);
			exponent = (NI64)(TMP345);
	...
	hd = tentothepowerof_94513(exponent);
